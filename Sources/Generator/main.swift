...
func generateFunction(ext: AST.Extension, type: String, name: String) {
...
func generateSWKStorageExtension(type: String) {
  createSourceFile(name: "SWKStorage+" + type) { src in
    src.comment("NB: autogenerated from " + generatedFrom)
    src.empty()
